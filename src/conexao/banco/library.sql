...
-- -----------------------------------------------------
-- Schema 3848728_library3ds
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema 3848728_library3ds
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `3848728_library3ds` DEFAULT CHARACTER SET utf8 ;
USE `3848728_library3ds` ;

-- -----------------------------------------------------
-- Table `3848728_library3ds`.`TIPO_USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3848728_library3ds`.`TIPO_USUARIO` (
...
-- -----------------------------------------------------
-- Table `3848728_library3ds`.`CURSO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3848728_library3ds`.`CURSO` (
...
-- -----------------------------------------------------
-- Table `3848728_library3ds`.`USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3848728_library3ds`.`USUARIO` (
  ...
  CONSTRAINT `fk_USUARIO_TIPO_USUARIO`
    ...
    REFERENCES `3848728_library3ds`.`TIPO_USUARIO` (`IDTIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USUARIO_CURSO1`
    FOREIGN KEY (`CURSO_IDCURSO`)
    REFERENCES `3848728_library3ds`.`CURSO` (`IDCURSO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3848728_library3ds`.`EIXO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3848728_library3ds`.`EIXO` (
...
-- -----------------------------------------------------
-- Table `3848728_library3ds`.`TRABALHO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3848728_library3ds`.`TRABALHO` (
...
-- -----------------------------------------------------
-- Table `3848728_library3ds`.`AUTOR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3848728_library3ds`.`AUTOR` (
  ...
  CONSTRAINT `fk_USUARIO_has_TRABALHO_USUARIO1`
    ...
    REFERENCES `3848728_library3ds`.`USUARIO` (`IDUSUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USUARIO_has_TRABALHO_TRABALHO1`
    FOREIGN KEY (`TRABALHO_IDTRABALHO`)
    REFERENCES `3848728_library3ds`.`TRABALHO` (`IDTRABALHO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3848728_library3ds`.`HISTORICO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3848728_library3ds`.`HISTORICO` (
